...
@section('title', 'Documentação do Sistema')
@section('page-title', 'Documentação')
...
<div class="row">
    <div class="col-12">
        ...
        <div class="quick-links">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="{{ route('admin.documentation.show', 'instalacao') }}" class="btn btn-outline-primary btn-sm w-100 mb-2">
                        <i class="bi bi-download"></i> Instalação
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('admin.documentation.show', 'manual-usuario') }}" class="btn btn-outline-success btn-sm w-100 mb-2">
                        <i class="bi bi-person-check"></i> Manual do Usuário
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('admin.documentation.show', 'configuracao-smtp') }}" class="btn btn-outline-info btn-sm w-100 mb-2">
                        <i class="bi bi-envelope-gear"></i> Config. SMTP
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('admin.documentation.show', 'faq') }}" class="btn btn-outline-warning btn-sm w-100 mb-2">
        ...
        <div class="row">
            @foreach($structure as $sectionName => $documents)
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card documentation-card h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center mb-3">{{ $sectionName }}</h5>
                        
                        <div class="doc-links">
                            @foreach($documents as $slug => $title)
                                <a href="{{ route('admin.documentation.show', $slug) }}" class="doc-link">
                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><strong>Última Atualização:</strong> {{ date('d/m/Y') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function performSearch(query) {
        $.ajax({
            url: '{{ route("admin.documentation.search") }}',
            method: 'GET',
            data: { q: query },
