...
<div class="row mb-4">
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="analytics-card" style="background:linear-gradient(135deg,#FF6B00,#E55A00);">
            <div class="card-value" id="statTotal">{{ number_format($stats['total_visits']) }}</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="analytics-card" style="background:linear-gradient(135deg,#28a745,#20c997);">
            <div class="card-value" id="statUnique">{{ number_format($stats['unique_visits']) }}</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="analytics-card" style="background:linear-gradient(135deg,#17a2b8,#6f42c1);">
            <div class="card-value"><span class="live-dot me-1"></span> <span id="statOnline">{{ $stats['online_now'] }}</span></div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="analytics-card" style="background:linear-gradient(135deg,#ffc107,#fd7e14);">
            <div class="card-value"><span id="statAvg">{{ number_format($stats['avg_time']) }}</span>s</div>
