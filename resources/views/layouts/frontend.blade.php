...
<div id="preloader">
    @if(!empty($siteSettings['site_logo']))
        <img src="{{ str_starts_with($siteSettings['site_logo'], 'http') ? $siteSettings['site_logo'] : asset(ltrim($siteSettings['site_logo'], '/')) }}" alt="{{ $siteSettings['site_name'] ?? 'HomeMechanic' }}" style="height:72px;width:auto;object-fit:contain;">
    @else
...
<footer class="pt-5 pb-0">
    <div class="container">
        <div class="row g-5 pb-5">
            <div class="col-lg-4">
                @if(!empty($siteSettings['site_logo']))
                    <img src="{{ str_starts_with($siteSettings['site_logo'], 'http') ? $siteSettings['site_logo'] : asset(ltrim($siteSettings['site_logo'], '/')) }}" alt="{{ $siteSettings['site_name'] ?? 'HomeMechanic' }}" style="height:52px;width:auto;object-fit:contain;margin-bottom:1rem;">
                @else
