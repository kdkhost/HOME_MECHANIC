...
<?php $__env->startSection('title', 'reCAPTCHA / Segurança'); ?>
...
<div class="row">
    <?php echo $__env->make('modules.settings._sidebar', ['active' => 'recaptcha'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="col-md-9">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center gap-3">
                    <?php if($settings['recaptcha_enabled'] === '1' && !empty($settings['recaptcha_site_key'])): ?>
                    ...
                    <?php elseif($settings['recaptcha_enabled'] === '1' && empty($settings['recaptcha_site_key'])): ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.settings.recaptcha.update')); ?>">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="recaptcha_enabled"
                                   ...
                                   <?php echo e($settings['recaptcha_enabled'] === '1' ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="recaptcha_secret"
                                   id="recaptcha_secret"
                                   value="<?php echo e($settings['recaptcha_secret']); ?>"
                                   placeholder="6Lc..."
                    ...
                    <div class="form-group mb-0">
                        <label>
                            ...
                            <span id="thresholdVal"
                                ...
                                <?php echo e($settings['recaptcha_threshold']); ?>
                        ...
                        <input type="range" class="form-range" name="recaptcha_threshold"
                               ...
                               value="<?php echo e($settings['recaptcha_threshold']); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\settings\recaptcha.blade.php ENDPATH**/ ?>