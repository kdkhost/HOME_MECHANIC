...
<?php $__env->startSection('title', 'Upload de Arquivos'); ?>
<?php $__env->startSection('page-title', 'Upload de Arquivos'); ?>
...
function loadFiles() {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.upload.index")); ?>?' + params,
...
function uploadFiles(files) {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.upload.store-multiple")); ?>',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\upload\index.blade.php ENDPATH**/ ?>