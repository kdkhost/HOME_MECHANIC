...
<?php $__env->startSection('title', 'Erro Interno do Servidor'); ?>
                ...
                <div class="error-content text-center">
                    ...
                    <div class="error-help mt-5">
                        <p class="text-muted">
                            ...
                            <a href="<?php echo e(url('/contato')); ?>" class="text-primary">formulário de contato</a>.
                        </p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\errors\500.blade.php ENDPATH**/ ?>