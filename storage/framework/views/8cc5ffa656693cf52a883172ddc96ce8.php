...
<?php $__env->startSection('title', 'E-mail (SMTP)'); ?>
...
<div class="row">
    <?php echo $__env->make('modules.settings._sidebar', ['active' => 'email'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="col-md-9">
        ...
        <div class="card">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" id="smtpForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="mail_driver" id="mail_driver" style="max-width:220px;">
                            ...
                            <option value="log"      <?php echo e(($settings['mail_driver'] ?? '') === 'log'      ? 'selected' : ''); ?>>Log (Desenvolvimento)</option>
                        </select>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mail_host" id="mail_host"
                                       value="<?php echo e($settings['mail_host'] ?? 'smtp.gmail.com'); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" 
                                           ...
                                           placeholder="<?php echo e(($settings['mail_password_set'] ?? false) ? '••••••••' : 'Sua senha SMTP'); ?>"
                                           autocomplete="new-password">
                                    <button type="button" class="btn btn-outline-secondary" id="togglePassword" title="Mostrar/ocultar senha">
                                        <i class="fas fa-eye" id="eyeIcon"></i>
                                    </button>
                                </div>
                                <?php if($settings['mail_password_set'] ?? false): ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control" name="mail_encryption" id="mail_encryption">
                                    <option value="tls" <?php echo e(($settings['mail_encryption'] ?? 'tls') === 'tls' ? 'selected' : ''); ?>>TLS (porta 587)</option>
                                    <option value="ssl" <?php echo e(($settings['mail_encryption'] ?? '') === 'ssl' ? 'selected' : ''); ?>>SSL (porta 465)</option>
                                    <option value=""    <?php echo e(($settings['mail_encryption'] ?? '') === ''    ? 'selected' : ''); ?>>Nenhuma (porta 25)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 mt-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="mail_verify_peer" name="mail_verify_peer" value="1" 
                                    <?php echo e(($settings['mail_verify_peer'] ?? '1') === '0' ? '' : 'checked'); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mail_from_name" id="mail_from_name"
                                       value="<?php echo e($settings['mail_from_name'] ?? 'HomeMechanic'); ?>"
...
document.getElementById('btnTestSmtp').addEventListener('click', function() {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.settings.email.test")); ?>',
        method: 'POST',
        data: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\settings\email.blade.php ENDPATH**/ ?>