...
<?php $__env->startSection('title', 'SEO — ' . ($pageTypes[$seoSetting->page_type] ?? 'Configuração')); ?>
<?php $__env->startSection('page-title', 'SEO'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.seo.index')); ?>">SEO</a></li>
    <li class="breadcrumb-item active"><?php echo e($pageTypes[$seoSetting->page_type] ?? 'Configuração'); ?></li>
...
<div class="page-header">
    <h2 class="page-header-title">
        ...
        SEO — <?php echo e($pageTypes[$seoSetting->page_type] ?? 'Configuração'); ?>
...
<form method="POST" action="<?php echo e(route('admin.seo.store')); ?>" id="seoForm">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="page_type" value="<?php echo e($seoSetting->page_type); ?>">
    <input type="hidden" name="page_identifier" value="<?php echo e($seoSetting->page_identifier); ?>">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                    ...
                    <div class="tab-pane active" id="tab-basic">
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="form-control"
                                   value="<?php echo e(old('meta_title', $seoSetting->meta_title)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" class="form-control" rows="3"
                                      ...
                                      maxlength="500"><?php echo e(old('meta_description', $seoSetting->meta_description)); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_keywords" class="form-control"
                                   value="<?php echo e(old('meta_keywords', $seoSetting->meta_keywords)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="canonical_url" class="form-control"
                                   value="<?php echo e(old('canonical_url', $seoSetting->canonical_url)); ?>"
                            ...
                            <div class="col-sm-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="index"
                                           name="index" value="1"
                                           <?php echo e(old('index', $seoSetting->index ?? true) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-sm-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="follow"
                                           name="follow" value="1"
                                           <?php echo e(old('follow', $seoSetting->follow ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="tab-pane" id="tab-og">
                        <div class="form-group">
                            ...
                            <input type="text" name="og_title" class="form-control"
                                   value="<?php echo e(old('og_title', $seoSetting->og_title)); ?>"
                                   placeholder="Título para compartilhamento (Facebook, LinkedIn...)">
                        </div>
                        <div class="form-group">
                            <label>OG Description</label>
                            <textarea name="og_description" class="form-control" rows="3"
                                      placeholder="Descrição para compartilhamento"><?php echo e(old('og_description', $seoSetting->og_description)); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>OG Image (URL)</label>
                            <input type="url" name="og_image" id="og_image" class="form-control"
                                   value="<?php echo e(old('og_image', $seoSetting->og_image)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select name="og_type" class="form-control" style="max-width:200px;">
                                <?php $__currentLoopData = ['website'=>'Website','article'=>'Article','blog'=>'Blog','profile'=>'Profile']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(old('og_type', $seoSetting->og_type ?? 'website') == $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                    ...
                    <div class="tab-pane" id="tab-twitter">
                        <div class="form-group">
                            ...
                            <select name="twitter_card" class="form-control" style="max-width:250px;">
                                <?php $__currentLoopData = ['summary_large_image'=>'Summary Large Image','summary'=>'Summary','app'=>'App','player'=>'Player']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(old('twitter_card', $seoSetting->twitter_card ?? 'summary_large_image') == $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="twitter_title" class="form-control"
                                   value="<?php echo e(old('twitter_title', $seoSetting->twitter_title)); ?>"
                                   placeholder="Título para Twitter">
                        </div>
                        <div class="form-group">
                            <label>Twitter Description</label>
                            <textarea name="twitter_description" class="form-control" rows="3"
                                      placeholder="Descrição para Twitter"><?php echo e(old('twitter_description', $seoSetting->twitter_description)); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Twitter Image (URL)</label>
                            <input type="url" name="twitter_image" class="form-control"
                                   value="<?php echo e(old('twitter_image', $seoSetting->twitter_image)); ?>"
                    ...
                    <div class="tab-pane" id="tab-advanced">
                        <div class="form-group">
                            ...
                            <textarea name="schema_markup" id="schema_markup" class="form-control"
                                      ...
                                      placeholder='{"@context":"https://schema.org","@type":"AutoRepair",...}'><?php echo e(old('schema_markup', $seoSetting->schema_markup)); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="custom_head_tags" class="form-control" rows="5"
                                      ...
                                      placeholder="<!-- Tags HTML personalizadas -->"><?php echo e(old('custom_head_tags', $seoSetting->custom_head_tags)); ?></textarea>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('admin.seo.index')); ?>" class="btn btn-secondary ms-2">Cancelar</a>
                </div>
            </div>
                    ...
                    <div id="hashtags-list" class="d-flex flex-wrap gap-1">
                        <?php $__currentLoopData = $hashtags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="badge badge-secondary" style="cursor:pointer; font-size:0.75rem;"
                                  onclick="copyHashtag('<?php echo e($tag); ?>')"><?php echo e($tag); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\seo\form.blade.php ENDPATH**/ ?>