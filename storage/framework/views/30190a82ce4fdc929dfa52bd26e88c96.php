...
<?php $__env->startSection('title', 'Blog — HomeMechanic Tuning & Performance'); ?>
...
<section style="padding:4rem 0; background:var(--black);">
    <div class="container">
        ...
        <div class="blog-featured" data-aos="fade-up">
            <div class="row g-0">
                <div class="col-lg-6">
                    <img src="<?php echo e($featured->cover_image ? asset($featured->cover_image) : 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=900&q=80'); ?>"
                         alt="<?php echo e($featured->title); ?>" class="blog-featured-img" style="height:100%; min-height:320px; object-fit:cover;">
                </div>
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="blog-featured-body">
                        <span class="blog-cat">Em Destaque</span>
                        <h2 class="blog-title" style="font-size:1.8rem;"><?php echo e($featured->title); ?></h2>
                        <p class="blog-excerpt"><?php echo e($featured->excerpt); ?></p>
                        <div class="blog-meta mb-3">
                            <span><i class="bi bi-calendar3"></i> <?php echo e($featured->published_at?->format('d M Y')); ?></span>
                            <?php $words = str_word_count(strip_tags($featured->content ?? '')); $mins = max(1, round($words/200)); ?>
                            <span><i class="bi bi-clock"></i> <?php echo e($mins); ?> min de leitura</span>
                        </div>
                        <a href="<?php echo e(route('blog.post', $featured->slug)); ?>" class="blog-read mt-1 d-inline-flex">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e(($loop->index % 3) * 80); ?>">
                <div class="blog-card">
                    <a href="<?php echo e(route('blog.post', $p->slug)); ?>" style="display:block;">
                        <div class="blog-img-wrap">
                            <img src="<?php echo e($p->cover_image ? asset($p->cover_image) : 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&q=80'); ?>"
                                 alt="<?php echo e($p->title); ?>" class="blog-img" loading="lazy">
                        </div>
                    </a>
                    <div class="blog-body">
                        <?php if($p->category): ?>
                            <span class="blog-cat"><?php echo e($p->category->name); ?></span>
                        <?php endif; ?>
                        <a href="<?php echo e(route('blog.post', $p->slug)); ?>" style="text-decoration:none;">
                            <div class="blog-title"><?php echo e($p->title); ?></div>
                        </a>
                        <p class="blog-excerpt"><?php echo e($p->excerpt); ?></p>
                        <div class="blog-meta mb-3">
                            <span><i class="bi bi-calendar3"></i> <?php echo e($p->published_at?->format('d M Y')); ?></span>
                            <?php $w = str_word_count(strip_tags($p->content ?? '')); ?>
                            <span><i class="bi bi-clock"></i> <?php echo e(max(1,round($w/200))); ?> min</span>
                        </div>
                        <a href="<?php echo e(route('blog.post', $p->slug)); ?>" class="blog-read">
        ...
        ?>
        <div class="row g-4">
            <?php $__currentLoopData = $staticPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e(($i % 3) * 80); ?>">
                <div class="blog-card">
                    <div class="blog-img-wrap">
                        <img src="<?php echo e($p['img']); ?>" alt="<?php echo e($p['title']); ?>" class="blog-img" loading="lazy">
                    </div>
                    <div class="blog-body">
                        <span class="blog-cat"><?php echo e($p['cat']); ?></span>
                        <div class="blog-title"><?php echo e($p['title']); ?></div>
                        <p class="blog-excerpt"><?php echo e($p['excerpt']); ?></p>
                        <div class="blog-meta mb-3">
                            <span><i class="bi bi-calendar3"></i> <?php echo e($p['date']); ?></span>
                            <span><i class="bi bi-clock"></i> <?php echo e($p['read']); ?></span>
                        </div>
                        <a href="<?php echo e(route('contact')); ?>" class="blog-read">Entre em contato <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\frontend\blog.blade.php ENDPATH**/ ?>