...
<?php $__env->startSection('title', 'Configurações Gerais'); ?>
...
<div class="row">
    <?php echo $__env->make('modules.settings._sidebar', ['active' => 'general'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="col-md-9">
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" id="settingsForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="site_description" rows="3"><?php echo e(old('site_description', $settings['site_description'] ?? '')); ?></textarea>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'site_logo','value' => !empty($settings['site_logo']) ? (str_starts_with($settings['site_logo'], 'http') ? $settings['site_logo'] : '/' . ltrim($settings['site_logo'], '/')) : null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'site_logo','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!empty($settings['site_logo']) ? (str_starts_with($settings['site_logo'], 'http') ? $settings['site_logo'] : '/' . ltrim($settings['site_logo'], '/')) : null)]); ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (isset($component)) { $__componentOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'site_favicon','value' => !empty($settings['site_favicon']) ? (str_starts_with($settings['site_favicon'], 'http') ? $settings['site_favicon'] : '/' . ltrim($settings['site_favicon'], '/')) : null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filepond'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'site_favicon','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!empty($settings['site_favicon']) ? (str_starts_with($settings['site_favicon'], 'http') ? $settings['site_favicon'] : '/' . ltrim($settings['site_favicon'], '/')) : null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5)): ?>
<?php $attributes = $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control" name="social_tiktok"
                                           value="<?php echo e(old('social_tiktok', $settings['social_tiktok'] ?? '')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="cep-wrap">
                                    <input type="text" class="form-control" name="address_cep" id="address_cep"
                                           data-mask="cep"
                                           value="<?php echo e(old('address_cep', $settings['address_cep'] ?? '')); ?>"
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_street" id="address_street"
                                       value="<?php echo e(old('address_street', $settings['address_street'] ?? '')); ?>"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_number" id="address_number"
                                       value="<?php echo e(old('address_number', $settings['address_number'] ?? '')); ?>"
                                       placeholder="Nº">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_complement" id="address_complement"
                                       value="<?php echo e(old('address_complement', $settings['address_complement'] ?? '')); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_district" id="address_district"
                                       value="<?php echo e(old('address_district', $settings['address_district'] ?? '')); ?>"
                                       placeholder="Bairro">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_city" id="address_city"
                                       value="<?php echo e(old('address_city', $settings['address_city'] ?? '')); ?>"
                                       placeholder="Cidade">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address_state" id="address_state"
                                       value="<?php echo e(old('address_state', $settings['address_state'] ?? '')); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="timezone">
                                    ...
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tz); ?>" <?php echo e(($settings['timezone'] ?? 'America/Sao_Paulo') === $tz ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        ...
                        <div class="col-md-4">
                            <div class="custom-control custom-switch custom-switch-lg">
                                <input type="checkbox" class="custom-control-input" id="analytics_enabled"
                                       ...
                                       <?php echo e(($settings['analytics_enabled'] ?? '0') === '1' ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="google_place_id"
                                       value="<?php echo e(old('google_place_id', $settings['google_place_id'] ?? '')); ?>"
                                       placeholder="ChIJ...">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" name="google_places_api_key" id="googleApiKey"
                                           value="<?php echo e(old('google_places_api_key', $settings['google_places_api_key'] ?? '')); ?>"
                                           placeholder="AIza...">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\settings\index.blade.php ENDPATH**/ ?>