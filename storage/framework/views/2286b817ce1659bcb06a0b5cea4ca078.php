            ...
            <div class="col-lg-6 col-md-8">
                <div class="error-content text-center">
                    ...
                    <div class="error-actions">
                        ...
                        <a href="<?php echo e(url('/admin/login')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\errors\403.blade.php ENDPATH**/ ?>