...
<?php $__env->startSection('title', 'Serviços — HomeMechanic Tuning & Performance'); ?>
<?php $__env->startSection('description', 'Tuning de motor, suspensão sport, estética premium e diagnóstico digital para supercars de luxo.'); ?>
...
<section style="padding:5rem 0; background:var(--black);">
    <div class="container">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e(($loop->index % 3) * 80); ?>">
                <div class="service-full-card h-100">
                    ...
                    <div class="service-full-img-wrap">
                        <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($s->title); ?>" class="service-full-img" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=800&h=500&fit=crop'">
                    </div>
                    <div class="service-full-body">
                        <div class="service-full-icon"><i class="bi <?php echo e($s->icon ?? 'bi-tools'); ?>"></i></div>
                        <div class="service-full-title"><?php echo e($s->title); ?></div>
                        <p class="service-full-text"><?php echo e($s->description); ?></p>
                        <?php if($s->content): ?>
                        <div class="service-full-text mt-2" style="font-size:0.85rem;"><?php echo \Illuminate\Support\Str::limit(strip_tags($s->content), 200); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        ?>
        <div class="row g-4">
            <?php $__currentLoopData = $staticServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e(($i % 3) * 80); ?>">
                <div class="service-full-card h-100">
                    <div class="service-full-img-wrap">
                        <img src="<?php echo e($s['img']); ?>" alt="<?php echo e($s['title']); ?>" class="service-full-img">
                    </div>
                    <div class="service-full-body">
                        <div class="service-full-icon"><i class="bi <?php echo e($s['icon']); ?>"></i></div>
                        <div class="service-full-title"><?php echo e($s['title']); ?></div>
                        <p class="service-full-text"><?php echo e($s['text']); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\frontend\services.blade.php ENDPATH**/ ?>