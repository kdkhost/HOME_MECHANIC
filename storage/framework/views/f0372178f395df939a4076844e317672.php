            ...
            <div class="row g-0">
                ...
                <div class="col-lg-7">
                    <div class="login-right">
                        ...
                        <!-- Formulário de Login -->
                        <form id="loginForm" method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="text-center mt-4">
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?php echo e(route('admin.password.request')); ?>" class="text-muted small text-decoration-none">
                                        <i class="bi bi-question-circle me-1"></i>
                                        Esqueceu a senha?
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo e(url('/')); ?>" class="text-muted small text-decoration-none">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkRateLimit() {
                fetch('<?php echo e(route("admin.auth.rate-limit-info")); ?>', {
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Accept': 'application/json'
                    }
            ...
            function checkAuthStatus() {
                fetch('<?php echo e(route("admin.auth.check")); ?>', {
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Accept': 'application/json'
                    }
        ...
        function renewSession() {
            fetch('<?php echo e(route("admin.auth.renew-session")); ?>', {
                method: 'POST',
                headers: {
...
</html><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\auth\login.blade.php ENDPATH**/ ?>