...
<?php $__env->startSection('title', 'Galeria - HomeMechanic'); ?>
<?php $__env->startSection('page-title', 'Galeria'); ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('admin.gallery.photos')); ?>" class="btn btn-info ml-2">
...
class GalleryManager {
    ...
    async loadCategories(page = 1) {
        try {
            ...
            const response = await fetch(`<?php echo e(route('admin.gallery.index')); ?>?${params}`, {
                headers: {
                ...
                <div class="card category-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group btn-group-sm">
                                <a href="<?php echo e(route('admin.gallery.photos')); ?>/${category.id}" class="btn btn-outline-primary" title="Ver Fotos">
                                    <i class="bi bi-eye"></i>
                                </a>
    ...
    async handleReorder(evt) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.gallery.categories.reorder")); ?>', {
                method: 'POST',
                headers: {
    ...
    async editCategory(id) {
        try {
            const response = await fetch(`<?php echo e(route('admin.gallery.index')); ?>`, {
                headers: {
                    'Accept': 'application/json'
                }
            });
    ...
    async handleSubmit(e) {
        ...
        const url = this.editingId 
            ? `<?php echo e(route('admin.gallery.index')); ?>/categories/${this.editingId}`
            : '<?php echo e(route("admin.gallery.categories.store")); ?>';
    ...
    async deleteCategory(id) {
        ...
        try {
            const response = await fetch(`<?php echo e(route('admin.gallery.index')); ?>/categories/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    'Accept': 'application/json'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\gallery\index.blade.php ENDPATH**/ ?>