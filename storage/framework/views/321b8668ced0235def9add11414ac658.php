...
<?php $__env->startSection('title', $post->title . ' — HomeMechanic'); ?>
...
<div class="post-hero">
    <div class="post-hero-bg" style="background-image:url('<?php echo e($post->cover_image ? asset($post->cover_image) : 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=1600&q=80'); ?>')"></div>
    ...
    <div class="container post-hero-content">
        ...
        <?php if($post->category): ?>
            <span class="post-cat-badge mb-3 d-inline-block"><?php echo e($post->category->name); ?></span>
        <?php endif; ?>
        ...
        <div class="post-meta">
            <?php if($post->author): ?>
            <span><i class="bi bi-person-fill"></i> <?php echo e($post->author->name); ?></span>
            <?php endif; ?>
            <span><i class="bi bi-calendar3"></i> <?php echo e($post->published_at?->format('d \d\e F \d\e Y')); ?></span>
            <?php $words = str_word_count(strip_tags($post->content ?? '')); $mins = max(1, round($words/200)); ?>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('blog')); ?>" class="btn-outline-orange" style="padding:0.7rem 1.5rem;font-size:0.8rem;">
            ...
            <div class="col-lg-4">
                <div class="post-sidebar">
                    ...
                    <div style="background:linear-gradient(135deg,var(--orange-dark),var(--orange));border-radius:8px;padding:1.75rem;margin-bottom:1.5rem;text-align:center;">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="btn-orange" style="background:rgba(0,0,0,0.85) !important;color:#FF6B00 !important;width:100%;justify-content:center;border:none !important;">
                    ...
                    <div style="background:var(--dark2);border:1px solid rgba(255,255,255,0.06);border-radius:8px;overflow:hidden;">
                        ...
                        <div style="padding:1rem;">
                            ...
                            <a href="<?php echo e(route('blog.post', $r->slug)); ?>" style="display:flex;gap:0.85rem;align-items:flex-start;padding:0.75rem 0;border-bottom:1px solid rgba(255,255,255,0.05);text-decoration:none;" class="related-link">
                                <img src="<?php echo e($r->cover_image ? asset($r->cover_image) : 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=120&q=70'); ?>"
                                ...
                                <div>
                                    <div style="font-size:0.85rem;font-weight:600;color:var(--white);line-height:1.3;margin-bottom:0.3rem;transition:color 0.2s;" class="related-link-title">
                                        <?php echo e(\Illuminate\Support\Str::limit($r->title, 55)); ?>

                                    </div>
                                    <div style="font-size:0.72rem;color:var(--gray);">
                                        <?php echo e($r->published_at?->format('d M Y')); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\frontend\blog-post.blade.php ENDPATH**/ ?>