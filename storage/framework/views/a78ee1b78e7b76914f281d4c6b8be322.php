...
<body>
    ...
    <div class="installer-container">
        <div class="installer-card">
            ...
            <div class="installer-body">
                <form id="installForm" method="POST" action="<?php echo e(route('installer.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="system_url" name="system_url" value="https://<?php echo e(request()->getHost()); ?>">
                        </div>
                    </div>
                    
                    <!-- Botões de Ação -->
                    <div class="text-center">
                        <a href="<?php echo e(route('installer.index')); ?>" class="btn btn-outline-secondary me-3">
    ...
    <script src="<?php echo e(asset('js/installer-debug.js')); ?>"></script>
...
</html><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\installer\form-debug.blade.php ENDPATH**/ ?>