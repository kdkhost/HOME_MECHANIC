<?php $__env->startSection('title', 'Patrocinadores'); ?>
<?php $__env->startSection('page-title', 'Patrocinadores'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'logo','id' => 'sponsorLogo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'logo','id' => 'sponsorLogo']); ?>
...
function loadSponsors(page = 1) {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.sponsors.index")); ?>?' + params.toString(),
    ...
    if (list) {
        sortable = Sortable.create(list, {
            ...
            onEnd: function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.sponsors.reorder")); ?>',
                    method: 'POST',
...
function editSponsor(id) {
    $.ajax({
        url: '<?php echo e(url("admin/sponsors")); ?>/' + id,
...
document.getElementById('sponsorForm').addEventListener('submit', function(e) {
    ...
    var url = id ? '<?php echo e(url("admin/sponsors")); ?>/' + id : '<?php echo e(route("admin.sponsors.store")); ?>';
...
function toggleActive(id) {
    $.ajax({
        url: '<?php echo e(url("admin/sponsors")); ?>/' + id + '/toggle-active',
        method: 'PATCH',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\sponsors\index.blade.php ENDPATH**/ ?>