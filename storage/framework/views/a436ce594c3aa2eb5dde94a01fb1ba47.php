...
<?php $__env->startSection('title', 'Fotos da Galeria - Home Mechanic'); ?>
<?php $__env->startSection('page-title', 'Fotos da Galeria'); ?>

<?php $__env->startSection('breadcrumb'); ?>
<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard.index')); ?>">Dashboard</a></li>
<li class="breadcrumb-item"><a href="<?php echo e(route('admin.gallery.index')); ?>">Galeria</a></li>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <?php if($category): ?>
                        Fotos: <?php echo e($category->name); ?>
                ...
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('admin.gallery.index')); ?>" class="btn btn-secondary ml-2">
                    ...
                    <div class="col-md-2">
                        <select id="categoryFilter" class="form-control">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>" <?php echo e($category && $category->id == $cat->id ? 'selected' : ''); ?>>
                                    <?php echo e($cat->name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'filename','id' => 'photo_filename','required' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'filename','id' => 'photo_filename','required' => 'true']); ?>
...
<?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if (isset($component)) { $__componentOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'thumbnail','id' => 'photo_thumbnail']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filepond'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'thumbnail','id' => 'photo_thumbnail']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5)): ?>
<?php $attributes = $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5; ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($component)) { $__componentOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'mass_photos[]','id' => 'mass_photos','multiple' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filepond'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'mass_photos[]','id' => 'mass_photos','multiple' => 'true']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5)): ?>
<?php $attributes = $__attributesOriginal3ddfa68e14b19345c5eae6d0123c1be5; ?>
...
class PhotosManager {
    ...
    async loadPhotos(page = 1) {
        try {
            ...
            const url = categoryId 
                ? `<?php echo e(route('admin.gallery.photos', '')); ?>/${categoryId}?${params}`
                : `<?php echo e(route('admin.gallery.photos')); ?>?${params}`;
    ...
    async handleReorder(evt) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.gallery.photos.reorder")); ?>', {
                method: 'POST',
                headers: {
    ...
    async handleSubmit(e) {
        ...
        try {
            const url = this.editingId 
                ? `<?php echo e(route('admin.gallery.photos.update', '')); ?>/${this.editingId}`
                : `<?php echo e(route('admin.gallery.photos.store')); ?>`;
    ...
    async processMassUpload() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("admin.gallery.photos.mass-store")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
    ...
    async editPhoto(id) {
        try {
            ...
            const response = await fetch(`<?php echo e(route('admin.gallery.photos')); ?>?photo_id=${id}`, {
    ...
    async deletePhoto(id) {
        ...
        if (result.isConfirmed) {
            try {
                const response = await fetch(`<?php echo e(route('admin.gallery.photos.destroy', '')); ?>/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                        'Accept': 'application/json'
    ...
    async toggleActive(id) {
        try {
            const response = await fetch(`<?php echo e(route('admin.gallery.photos.toggle-active', '')); ?>/${id}`, {
                method: 'PATCH',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    'Accept': 'application/json'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\gallery\photos.blade.php ENDPATH**/ ?>