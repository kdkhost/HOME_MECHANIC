...
<?php $__env->startSection('title', 'HomeMechanic — Tuning & Performance de Luxo'); ?>
<?php $__env->startSection('description', 'Especialistas em tuning, performance e manutenção de supercars. Lamborghini, Ferrari, Porsche, McLaren e muito mais.'); ?>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="hero-badge">
                    ...
                    <?php echo e($siteSettings['hero_badge_text']); ?>

                </div>
                <h1 class="hero-title">
                    <?php echo nl2br(e($siteSettings['hero_title'])); ?>

                </h1>
                <p class="hero-sub">
                    <?php echo e($siteSettings['hero_subtitle']); ?>

                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('contact')); ?>" class="btn-orange">
                        <i class="bi bi-calendar-check"></i> Agendar Visita
                    </a>
                    <a href="<?php echo e(route('services')); ?>" class="btn-outline-orange">
                        <i class="bi bi-grid"></i> Nossos Serviços
                    </a>
                </div>
                <div class="hero-stats">
                    <div>
                        <div class="hero-stat-num"><?php echo e($siteSettings['hero_stat1_value']); ?></div>
                        <div class="hero-stat-label"><?php echo e($siteSettings['hero_stat1_label']); ?></div>
                    </div>
                    <div>
                        <div class="hero-stat-num"><?php echo e($siteSettings['hero_stat2_value']); ?></div>
                        <div class="hero-stat-label"><?php echo e($siteSettings['hero_stat2_label']); ?></div>
                    </div>
                    <div>
                        <div class="hero-stat-num"><?php echo e($siteSettings['hero_stat3_value']); ?></div>
                        <div class="hero-stat-label"><?php echo e($siteSettings['hero_stat3_label']); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-5" data-aos="fade-right">
                <div class="about-img-wrap me-lg-4">
                    ...
                    <div class="about-badge">
                        <div class="about-badge-num"><?php echo e($siteSettings['about_years']); ?></div>
                        <div class="about-badge-text"><?php echo e($siteSettings['about_subtitle']); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7" data-aos="fade-left">
                ...
                <h2 class="section-title mb-3">
                    <?php echo nl2br(e($siteSettings['about_title'])); ?>

                </h2>
                <div class="divider-orange"></div>
                <p class="section-sub mb-4">
                    <?php echo e($siteSettings['about_text']); ?>
...
<section class="services-section py-5" style="padding:5rem 0 !important;">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 80); ?>">
                <div class="service-card">
                    <div class="service-img-wrap">
                        ...
                        ?>
                        <img src="<?php echo e($svcImg ?? 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80'); ?>" alt="<?php echo e($s->title); ?>" class="service-img">
                    </div>
                    <div class="service-body">
                        <div class="service-icon"><i class="<?php echo e(empty($s->icon) ? 'bi bi-tools' : $s->icon); ?>"></i></div>
                        <div class="service-title"><?php echo e($s->title); ?></div>
                        <p class="service-text"><?php echo e(Str::limit($s->description, 90)); ?></p>
                        <a href="<?php echo e(route('services')); ?>" class="service-link">
    ...
    <div class="container">
        <div class="row mb-5 align-items-end">
            ...
            <div class="col-lg-6 text-lg-end" data-aos="fade-up" data-aos-delay="100">
                <a href="<?php echo e(route('gallery')); ?>" class="btn-outline-orange">
                    Ver Galeria Completa <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
        <div class="gallery-grid" data-aos="fade-up" data-aos-delay="150">
            <?php $__empty_1 = true; $__currentLoopData = $galleryPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="gallery-item">
                <img src="<?php echo e($photo->image_url); ?>" alt="<?php echo e($photo->title); ?>" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=400&fit=crop'">
                <div class="gallery-overlay"><span><?php echo e($photo->title); ?></span></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<section class="testimonials-section" style="padding:5rem 0;">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="testimonial-card">
                    <div class="testimonial-stars">
                        <?php for($k=1; $k<=5; $k++): ?>
                            <i class="<?php echo e($k <= $t->rating ? 'bi bi-star-fill' : 'bi bi-star'); ?>"></i>
                        <?php endfor; ?>
                    </div>
                    <p class="testimonial-text">"<?php echo e($t->content); ?>"</p>
                    <div class="testimonial-author">
                        <div class="testimonial-avatar"><?php echo e(strtoupper(substr($t->name, 0, 2))); ?></div>
                        <div>
                            <div class="testimonial-name"><?php echo e($t->name); ?></div>
                            <div class="testimonial-car"><?php echo e($t->role); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Sponsors -->
<?php if(isset($sponsors) && $sponsors->count() > 0): ?>
    ...
    <div class="container">
        ...
        <div class="sponsors-carousel" data-aos="fade-up">
            <div class="sponsors-track">
                ...
                <a href="<?php echo e($sponsor->website ?? '#'); ?>" class="sponsor-item <?php echo e($sponsor->animation_class); ?>" style="animation-duration: <?php echo e($sponsor->speed_value); ?>;" target="_blank" rel="noopener">
                    <?php if($sponsor->logo): ?>
                        <img src="<?php echo e($sponsor->logo_url); ?>" alt="<?php echo e($sponsor->name); ?>">
                    <?php else: ?>
                        <span style="color:var(--orange);font-weight:600;"><?php echo e($sponsor->name); ?></span>
                    <?php endif; ?>
                </a>
...
<section class="cta-section" data-aos="fade-up">
    <div class="container">
        <div class="cta-title"><?php echo nl2br(e($siteSettings['cta_title'])); ?></div>
        <p style="color:rgba(255,255,255,0.6); font-size:1.05rem; margin-bottom:2.5rem; max-width:500px; margin-left:auto; margin-right:auto;">
            <?php echo e($siteSettings['cta_text']); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\frontend\home.blade.php ENDPATH**/ ?>