...
<body>
            ...
            <div class="installer-body">
                <form id="installForm" method="POST" action="<?php echo e(route('installer.store')); ?>">
                    ...
                    <div class="action-buttons">
                        <a href="<?php echo e(route('installer.index')); ?>" class="btn-secondary">
    ...
    <script>
        ...
        async function testDatabase() {
            ...
            try {
                const response = await fetch('<?php echo e(route("installer.test-database")); ?>', {
                    method: 'POST',
                    body: formData
                });
...
</html><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\installer\form.blade.php ENDPATH**/ ?>