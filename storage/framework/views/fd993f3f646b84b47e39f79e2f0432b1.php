...
<?php $__env->startSection('title', 'Backup e Manutenção'); ?>
...
<div class="row">
    <?php echo $__env->make('modules.settings._sidebar', ['active' => 'backup'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="maintenance_title"
                                       value="<?php echo e(old('maintenance_title', $settings['maintenance_title'] ?? 'Site em Manutenção')); ?>"
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="maintenance_message"
                                       value="<?php echo e(old('maintenance_message', $settings['maintenance_message'] ?? 'Voltaremos em breve. Estamos realizando atualizações.')); ?>"
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" name="maintenance_timer"
                                       value="<?php echo e(old('maintenance_timer', $settings['maintenance_timer'] ?? '')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'maintenance_bg_image','maxFileSize' => '10MB','value' => $bgUrl]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'maintenance_bg_image','max-file-size' => '10MB','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bgUrl)]); ?>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="form-group mb-4">
                                ...
                                <div class="ip-manager-container p-3" style="background:#f8f9fa; border:1px solid #e9ecef; border-radius:8px;">
                                    <input type="hidden" name="maintenance_ips" id="maintenance_ips" value="<?php echo e(old('maintenance_ips', $settings['maintenance_ips'] ?? '')); ?>">
                                    ...
                                    <div class="mt-3 d-flex align-items-center justify-content-between">
                                        ...
                                        <small class="text-muted">Seu IP detectado: <strong id="my_current_ip"><?php echo e(request()->ip()); ?></strong></small>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <table class="table table-bordered mb-0" style="font-size:0.87rem;">
                    <tr><td class="font-weight-bold" width="35%">Versão PHP</td><td><?php echo e(PHP_VERSION); ?></td></tr>
                    <tr><td class="font-weight-bold">Versão Laravel</td><td><?php echo e(app()->version()); ?></td></tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <span class="badge badge-warning"><?php echo e(ucfirst(app()->environment())); ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr><td class="font-weight-bold">Fuso Horário</td><td><?php echo e(config('app.timezone')); ?></td></tr>
                    <tr><td class="font-weight-bold">Data/Hora do Servidor</td><td><?php echo e(now()->format('d/m/Y H:i:s')); ?></td></tr>
                </table>
            </div>
        </div>
...
function loadBackups() {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.settings.backup.list")); ?>',
        method: 'GET',
...
function runBackup(type) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route("admin.settings.backup.run")); ?>',
            method: 'POST',
            data: JSON.stringify({ type: type }),
            contentType: 'application/json',
            success: function(res) {
...
function deleteBackup(file) {
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route("admin.settings.backup.delete")); ?>',
            method: 'DELETE',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\settings\backup.blade.php ENDPATH**/ ?>