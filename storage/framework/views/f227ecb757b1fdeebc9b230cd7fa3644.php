...
<?php $__env->startSection('title', 'Galeria — HomeMechanic Tuning & Performance'); ?>
    ...
    <div class="container">
        <div class="filter-bar" data-aos="fade-up">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button class="filter-btn" data-filter=".cat-<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="gallery-masonry" data-aos="fade-up" data-aos-delay="100">
            <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="gallery-item mix cat-<?php echo e($p->category_id); ?>" onclick="openLightbox('<?php echo e($p->image_url); ?>')">
                <img src="<?php echo e($p->image_url); ?>" alt="<?php echo e($p->title); ?>" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=400&fit=crop'">
                <div class="gallery-overlay">
                    <div class="gallery-overlay-title"><?php echo e($p->title); ?></div>
                    <div class="gallery-overlay-sub"><?php echo e($p->category ? $p->category->name : ''); ?></div>
                </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\frontend\gallery.blade.php ENDPATH**/ ?>