...
<?php $__env->startSection('title', 'Novo Post'); ?>
...
<div class="card">
    ...
    <form method="POST" action="<?php echo e(route('admin.blog.store')); ?>" id="postForm">
        <?php echo csrf_field(); ?>
        <div class="card-body">
            <?php if($errors->any()): ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" value="<?php echo e(old('title')); ?>" required placeholder="Título do post">
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.filepond','data' => ['name' => 'cover_image']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'cover_image']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Tudo\HOME_MECHANIC\resources\views\modules\blog\create.blade.php ENDPATH**/ ?>